...
- Authorization/RLS foundation defects for reviewer publication, approved-serving integrity, caller-shaped audit fields, and imported-project ID collisions are fixed in-repo and statically retested. Focused live Supabase RLS verification now passes for role boundaries, user-owned tables, imported projects, and Project Intelligence analyses; broader privileged mutation audit coverage remains pending.
