...
- Public production smoke passed 20/20 against `https://azure-quest-pwa.vercel.app` after the Vercel project rename. Live Supabase/RLS, role-specific Admin, onboarding provider, and source-grounded content verification remain pending.
