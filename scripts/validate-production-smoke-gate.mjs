...
const required = [
  ...
  [runner, "PRODUCTION_SMOKE_STATUS=SKIPPED_PULL_REQUEST"],
  [runner, "it verifies the deployed production alias, not the unmerged branch"],
  [runner, "PRODUCTION_SMOKE_STATUS=WAITING_FOR_PRODUCTION_ALIAS"],
  [runner, "PRODUCTION_SMOKE_WAIT_SECONDS ?? \"120\""],
